...
const Dashboard = () => {
  ...
  return (
    <div className="mt-12 mx-auto max-w-[1200px]">
      {/* Metrics section */}
      <div className="flex justify-between gap-16 mt-10">
        <div className="bg-[#FF7F50] text-white text-center text-[24px] font-bold p-6 rounded-lg shadow-md w-[300px] h-[160px]">
          Total Food Items: {totalFoodItems}
        </div>
        <div className="bg-[#FF7F50] text-white text-center text-[24px] font-bold p-6 rounded-lg shadow-md w-[300px] h-[160px]">
          Total Users: {totalUsers}
      ...
      <div className="flex flex-wrap gap-8 mt-16">
        ...
        <div className="flex-1 min-w-[320px] max-w-[600px]">
          <h3 className="text-center mb-4 text-lg font-semibold">Food Items by Category</h3>
          <FoodItemsChart />
        </div>

        {/* Active Users Chart */}
        <div className="flex-1 min-w-[320px] max-w-[600px]">
          <h3 className="text-center mb-4 text-lg font-semibold">Active Users by Month</h3>
          <ActiveUsersChart />
        </div>
      </div>
    </div>
